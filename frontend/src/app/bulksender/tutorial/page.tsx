    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-lg grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col justify-center">
          <div className="aspect-w-16 aspect-h-90">
            <iframe
              className="rounded-lg shadow-lg"
              width="100%"
              height="100%"
              src="https://www.youtube.com/embed/MKG_6BqnhpI"
        ...
        <div className="flex flex-col justify-center bg-gray-50 p-5 rounded-lg shadow-inner">
